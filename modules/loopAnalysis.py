			...
			if seqCode[i:i+3] == '@£@':
				if seqCode[i + 3] in ('I','J'):
					...
					if count == 0:
						...
						for sub in (
							("@£@I1",'__CSEQ_rawline("IF(%s,%s,t%s_%s)");' % (self.__threadIndex[tName], l1, tName, count+1) if tName != "main_thread" or count != 0 else ''),
							("@£@J1",'__CSEQ_rawline("IF(%s,%s,t%s_%s)");' % (self.__threadIndex[tName], l1, tName, count+1) if tName != "main_thread" or count != 0 else ''),
							("@£@L1", str(count)),
							("@£@L2", str(count)),
							("@£@I2", ''), 
							("@£@I3", '')):
						...
						for sub in (
							("@£@I1", '__CSEQ_rawline("t%s_%s:"); __CSEQ_rawline("IF(%s,%s,t%s_%s)");' % (tName, count, self.__threadIndex[tName], l1, tName, count + 1 ) if tName != "main_thread" or count != 0 else ''),
							("@£@J1", '__CSEQ_rawline("t%s_%s:"); __CSEQ_rawline("IF(%s,%s,t%s_%s)");' % (tName, count, self.__threadIndex[tName], l1, tName, count + 1 ) if tName != "main_thread" or count != 0 else ''),
							("@£@L1", str(count)),
							("@£@L2", str(count)),
							("@£@I2", ''), 
							("@£@I3", '')):
